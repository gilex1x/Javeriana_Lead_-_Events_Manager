...
export const CardItem = ({ item }: CardItemProps): React.ReactElement => {
    ...
    return (
        <>
            <div className="flex flex-col h-full bg-white rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-shadow duration-300 relative group p-4 sm:p-5">
